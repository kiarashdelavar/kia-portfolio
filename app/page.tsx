        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <motion.div id="experience" initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer}>
            ...
            <div className="space-y-12 border-l-2 border-white/10 ml-4 pl-10 relative">
              ...
              {/* NEW EXPERIENCE: Computer Vision */}
              <motion.div variants={fadeUpSpring} className="relative group hover:translate-x-2 transition-transform">
                <span className="absolute -left-[49px] top-1.5 w-4 h-4 bg-emerald-400 rounded-full shadow-[0_0_15px_#34d399] group-hover:scale-150 transition-transform duration-500"></span>
              ...
              <motion.div variants={fadeUpSpring} className="relative group hover:translate-x-2 transition-transform">
                ...
                <p className="text-cyan-400 font-mono text-xs mt-2 mb-3 flex items-center gap-4 flex-wrap">
                  ...
                  <span className="flex items-center gap-1 text-slate-400"><Calendar size={12}/> Nov 2025 - Present</span>
                </p>
              ...
              <motion.div variants={fadeUpSpring} className="relative group hover:translate-x-2 transition-transform">
                ...
                <p className="text-violet-400 font-mono text-xs mt-2 mb-3 flex items-center gap-4 flex-wrap">
                  ...
                  <span className="flex items-center gap-1 text-slate-400"><MapPin size={12}/> Deventer, NL</span>
                  <span className="flex items-center gap-1 text-slate-400"><Calendar size={12}/> Oct 2025 - Present</span>
                </p>
            ...
            <div className="space-y-12 border-l-2 border-white/10 ml-4 pl-10 relative">
              <motion.div variants={fadeUpSpring} className="relative group hover:translate-x-2 transition-transform">
                ...
                <p className="text-violet-400 font-mono text-xs mt-2 mb-3 flex items-center gap-4 flex-wrap">
                  ...
                  <span className="flex items-center gap-1 text-slate-400"><MapPin size={12}/> Deventer, NL</span>
                  <span className="flex items-center gap-1 text-slate-400"><Calendar size={12}/> Sept 2024 - Present</span>
                </p>
              ...
              <motion.div variants={fadeUpSpring} className="relative group hover:translate-x-2 transition-transform">
                ...
                <p className="text-slate-300 font-mono text-xs mt-2 mb-3 flex items-center gap-4 flex-wrap">
                  ...
                  <span className="flex items-center gap-1 text-slate-400"><Calendar size={12}/> 2020 - 2023</span>
                </p>
